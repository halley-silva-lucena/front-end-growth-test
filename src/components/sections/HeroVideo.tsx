...
export const HeroVideo = ({ title, description, buttons, background }: HeroSection) => {
  return (
    <section className="w-full md:w-4/5 lg:w-full h-auto flex items center flex-col md:mx-auto lg:mx-auto px-4 lg:px-0">
      <div className="absolute inset-0">
        <Image src={background.url} alt="Background Image" fill objectFit="cover" quality={100} className="z-0" />
      </div>
